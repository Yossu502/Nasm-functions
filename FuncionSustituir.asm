SECTION .data
	...
	msgEntrada	db	'Introduzca su mensaje: ', 0h
   	msgFinal 	db 	'Cadena revertida: ', 0h
   	len_output1 	equ 	$-msgFinal
...
strInvert:
	cmp 	byte [ecx], 0x00      ;comparing [ecx] 
      	je 	reversa               ;jumping to reverse function
      	inc 	ecx
      	inc 	byte [counter]
      	inc 	byte [counter2]
      	jmp 	strInvert               ;repeating
      
      
reversa:
      	cmp 	byte [counter2], 0x30   	
      	je 	SalidaReversa               			
      	mov 	al, [ecx-1]            	
      	mov 	[esi], al            
